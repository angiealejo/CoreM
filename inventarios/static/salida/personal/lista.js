...
var url_nuevo = window.location.origin + "/salidas/personal/nuevo/"
var url_editar = window.location.origin + "/salidas/personal/editar/"
...
GridPrincipal.prototype.get_Columnas = function (e) {
    ...
    return [
        ...
        { field: "persona_entrega" , title: "Persona Entrega", width: "170px" },
        { field: "persona_recibe" , title: "Persona Recibe", width: "170px" },
        { field: "estado" , title: "Estado", width: "120px" },
        { field: "created_by" , title: "Usuario", width: "170px" },
    ...
    e.data.Inicializar_CeldasExcel();
        ...
        targeta_resultados.grid.kfuente_datos_excel.fetch(function () {
            ...
            kendo.saveAs({
                ...
                fileName: "Salidas_Personal.xlsx",
            });
        });
}