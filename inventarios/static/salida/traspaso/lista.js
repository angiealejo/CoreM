...
var url_nuevo = window.location.origin + "/salidas/traspaso/nuevo/"
var url_editar = window.location.origin + "/salidas/traspaso/editar/"
    ...
    e.data.Inicializar_CeldasExcel();
        ...
        targeta_resultados.grid.kfuente_datos_excel.fetch(function () {
            ...
            kendo.saveAs({
                ...
                fileName: "Salidas_Traspasos.xlsx",
            });
        });
}