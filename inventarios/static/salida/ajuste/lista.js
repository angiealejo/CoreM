...
var url_nuevo = window.location.origin + "/salidas/ajustes/nuevo/"
var url_editar = window.location.origin + "/salidas/ajustes/editar/"
...
GridPrincipal.prototype.get_Columnas = function (e) {
    ...
    return [
        { field: "pk" , title: "Id", width: "40px" },
        { field: "fecha" , title: "Fecha", width: "80px", format: "{0:dd-MMMM-yyyy}" },
