...
$(document).ready(function () {
    ...
    targeta_filtros.cambiar_ColorSelect()
...
TargetaFormulario.prototype.cambiar_ColorSelect = function () {
    this.$almacen_destino.each(function() {
    texto = $(this).text()
    //console.log(texto)
    if (texto.indexOf('DESHABILITADO')) {
            option = $(this).find('option')
            console.log(texto.indexOf('DESHABILITADO'))
            //console.log(option)
    ...
    e.data.Inicializar_CeldasExcel();
        ...
        targeta_resultados.grid.kfuente_datos_excel.fetch(function () {
            ...
            kendo.saveAs({
                ...
                fileName: "Saldo_Inicial_Detalle.xlsx",
            });
        });
}
