...
var url_editar = window.location.origin + "/entradas/compras/editar/"
...
TargetaFormulario.prototype.deshabilitar_Campos = function () {
    ...
    this.$proveedor.attr("disabled", true)
...
GridPrincipal.prototype.click_BotonEliminar = function (e) {
    e.preventDefault()
    if (targeta_formulario.$estado.val() == "CER") {
        console.log(targeta_formulario.$estado.val())
