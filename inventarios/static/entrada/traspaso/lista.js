...
var url_recibir = window.location.origin + "/entradas/traspaso/ver/"
...
GridPrincipal.prototype.get_Columnas = function (e) {
    ...
    return [
        ...
        { field: "almacen_destino" , title: "Almacén Destino", width: "350px" },
...

        {
           command: [
                {
                   text: " Ver Detalle",
                   click: this.click_BotonVer,
                   className: "boton_editar fa fa-eye"
                }, 
...
GridPrincipal.prototype.apply_Estilos = function (e) {
    ...
    // Aplicar Iconos
    e.sender.tbody.find(".k-button.fa.fa-eye").each(function(idx, element){
...
GridPrincipal.prototype.click_BotonVer = function (e) {

    e.preventDefault()
    var fila = this.dataItem($(e.currentTarget).closest('tr'))
    
    window.location.href = url_recibir + fila.pk + "/"
}
    ...
    e.data.Inicializar_CeldasExcel();
        ...
        targeta_resultados.grid.kfuente_datos_excel.fetch(function () {
            ...
            kendo.saveAs({
                ...
                fileName: "Entradas_Traspasos.xlsx",
            });
        });
}