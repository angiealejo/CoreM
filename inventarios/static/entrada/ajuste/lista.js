...
var url_nuevo = window.location.origin + "/entradas/ajustes/nuevo/"
var url_editar = window.location.origin + "/entradas/ajustes/editar/"
    ...
    e.data.Inicializar_CeldasExcel();
        ...
        targeta_resultados.grid.kfuente_datos_excel.fetch(function () {
            ...
            kendo.saveAs({
                ...
                fileName: "Entradas_Ajustes.xlsx",
            });
        });
}